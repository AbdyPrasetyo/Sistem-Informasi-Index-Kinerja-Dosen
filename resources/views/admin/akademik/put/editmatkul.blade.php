            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Form Perubahan Data Matakuliah
                        </h4>
                        ...
                        <div class="p-1.5 min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                <div class="col-span-12">
                                    <form action="{{ route('matkul.update', $matkul->matakuliah_id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="relative  mb-3">
                                            <input type="text" name="kode_matakuliah" id="hs-floating-input-kodematkul" value="{{ old('kode_matakuliah', $matkul->kode_matakuliah) }}"
                                                class="peer p-2.5 block w-full border-gray-200 rounded-md text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                        focus:pt-6
                                        focus:pb-2
                                      ...
                                      @enderror
                                        ...
                                        <div class="relative  mb-3">
                                            <input type="text" name="nama_matakuliah" id="hs-floating-input-namamatkul" value="{{ old('nama_matakuliah', $matkul->nama_matakuliah) }}"
                                                class="peer p-2.5 block w-full border-gray-200 rounded-md text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                        focus:pt-6
                                        focus:pb-2
                                        [&:not(:placeholder-shown)]:pt-6
                                      ...
                                      @enderror
                                        ...
                                        <div class="relative  mb-3">
                                            <input type="text" name="sks" id="hs-floating-input-sks" value="{{ old('sks', $matkul->sks) }}" class="peer p-2.5 block w-full border-gray-200 rounded-md text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                        focus:pt-6
                                        focus:pb-2
                                        [&:not(:placeholder-shown)]:pt-6
                                        [&:not(:placeholder-shown)]:pb-2
                                      ...
                                      @enderror
                                        ...
                                        <div class="relative mb-3">
                                            ...
                                            autofill:pb-2">
                                                ...
                                                <option value="1" {{ old('semester', $matkul->semester) == '1' ? 'selected' : '' }}>Semester I</option>
                                                <option value="2" {{ old('semester', $matkul->semester) == '2' ? 'selected' : '' }}>Semester II</option>
                                                <option value="3" {{ old('semester', $matkul->semester) == '3' ? 'selected' : '' }}>Semester III</option>
                                                <option value="4" {{ old('semester', $matkul->semester) == '4' ? 'selected' : '' }}>Semester IV</option>
                                                <option value="5" {{ old('semester', $matkul->semester) == '5' ? 'selected' : '' }}>Semester V</option>
                                                <option value="6" {{ old('semester', $matkul->semester) == '6' ? 'selected' : '' }}>Semester VI</option>
                                                <option value="7" {{ old('semester', $matkul->semester) == '7' ? 'selected' : '' }}>Semester VII</option>
                                                <option value="8" {{ old('semester', $matkul->semester) == '8' ? 'selected' : '' }}>Semester VIII</option>
                                        ...
                                        <div class="relative">
                                            ...
                                            autofill:pb-2">
                                                ...
                                                @foreach($prodi as $p)
                                                    <option value="{{ $p->prodi_id }}" {{ old('prodi_id', $matkul->prodi_id) == $p->prodi_id ? 'selected' : '' }}>{{ $p->nama_prodi }}</option>
                                                @endforeach
                                            </select>
                                            <label for="form_InputSelect3" class="absolute top-0 start-0 p-4 h-full truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                            peer-focus:text-xs
