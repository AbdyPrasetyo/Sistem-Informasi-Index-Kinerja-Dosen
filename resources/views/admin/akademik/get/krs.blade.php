            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data KRS Mahasiswa Universitas
                            Janabadra</h4>
                    ...
                    <div class="lg:col-span-8 md:col-span-12 sm:col-span-12 col-span-12">
                        <div class="flex justify-end items-center gap-3">
                            ...
                            <a href="{{ route('krs.create') }}"
                                ...
                                <i class="ti ti-users text-white text-lg leading-none"></i> Tambah Data
                                krs
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="p-1.5 min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                ...
                                <tbody class="divide-y divide-border dark:divide-darkborder">
                                    ...
                                    <tr class="search-items">
                                        ...
                                        <td
                                            class="usr-ph-no text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            {{ $k->kelas->dosen->nama_lengkap }}
                                        </td>

                                        <td
                                            class="usr-ph-no text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            {{ $k->kelas->matkul->nama_matakuliah }}
                                        </td>
                                        <td
                                            class="usr-ph-no text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            {{ $k->kelas->matkul->kode_matakuliah }}
                                        </td>
                                        <td
                                            class="usr-ph-no text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            {{ $k->kelas->tahun_ajaran }}
                                        </td>
                                        <td
                                            class="usr-ph-no text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            {{ $k->mahasiswa->prodi->nama_prodi }}
                                        </td>
                                        <td
                                            class="usr-ph-no text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            {{ $k->mahasiswa->prodi->fakultas->nama_fakultas }}
                                        </td>

                                        <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            <div class="action-btn flex gap-3">

                                                <form action="{{ route('krs.destroy', $k->krs_id) }}"
                                                    method="POST" id="delete-form-{{ $k->krs_id }}">
                                                    @csrf
                                                    @method('DELETE')

                                                    <button type="button" class="text-dark delete-btn" data-id="{{ $k->krs_id }}">
                                                        <i
                            ...
                            <div class="flex justify-center items-center gap-x-5 mt-4">
                                <div class="pagination-wrapper">
                                    {{ $krs->links('vendor.pagnation.custom') }}
                                </div>
                                <!-- Go To Page -->
