            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data Program Studi  Universitas
                            Janabadra</h4>
                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="lg:col-span-8 md:col-span-12 sm:col-span-12 col-span-12">
                        <div class="flex justify-end items-center gap-3">
                            ...
                            <a href="{{ route('prodi.create') }}" id="btn-add-contact"
                            ...
                            <div class="overflow-hidden">
                                ...
                                <table class="table search-table min-w-full divide-y divide-border dark:divide-darkborder">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-left rtl:text-right p-4 font-semibold text-dark dark:text-white text-sm">
                                                Program Studi</th>
                                            <th scope="col" class="text-left rtl:text-right p-4 font-semibold text-dark dark:text-white text-sm">
                                                Fakultas</th>
                                            <th scope="col" class="text-left rtl:text-right p-4 font-semibold text-dark dark:text-white text-sm">
                                        ...
                                        <tr class="search-items">
                                            ...
                                            <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                                <div class="action-btn flex gap-3">
                                                    <a href="{{ route('prodi.edit',$p->prodi_id) }}" class="text-info edit">
                                                        <i class="ti ti-pencil text-lg"></i>
                                                    </a>

                                                    <form action="{{ route('prodi.destroy', $p->prodi_id) }}" method="POST" id="delete-form-{{ $p->prodi_id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="text-dark delete-btn" data-id="{{ $p->prodi_id }}">
                                ...
                                <div class="flex justify-center items-center gap-x-5 mt-4">
                                    <div class="pagination-wrapper">
                                        {{ $prodi->links('vendor.pagnation.custom') }}
                                    </div>
                                    <!-- Go To Page -->
