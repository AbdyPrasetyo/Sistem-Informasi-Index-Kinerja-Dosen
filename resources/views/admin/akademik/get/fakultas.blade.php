            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data Fakultas Universitas
                            Janabadra</h4>
                            ...
                            <div class="overflow-hidden">
                                        ...
                                        <tr class="search-items">
                                            ...
                                            <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                                <div class="action-btn flex gap-3">
                                                    <a href="{{ route('fakultas.update', $f->fakultas_id) }}" class="text-info edit">
                                                        <i class="ti ti-pencil text-lg"></i>
                                                    </a>

                                                    <form action="{{ route('fakultas.destroy', $f->fakultas_id) }}"
                                                        method="POST"  id="delete-form-{{ $f->fakultas_id }}">
                                                        @csrf
                                                        @method('DELETE')

                                                        <button type="button" class="text-dark delete-btn" data-id="{{ $f->fakultas_id }}">
                                ...
                                <div class="flex justify-center items-center gap-x-5 mt-4">
                                    <div class="pagination-wrapper">
                                        {{ $fakultas->links('vendor.pagnation.custom') }}
                                    </div>
                                    <!-- Go To Page -->
    ...
    $(document).on('click', '.delete-btn', function () {
     ...
     Swal.fire({
         ...
         if (result.isConfirmed) {
             ...
             $('#delete-form-' + fakultas_id).submit();
         }
     });
 });
 </script>
...
{{--
     <button id="btn-add" class="btn bg-success hover:bg-successemphasis text-white px-4">Save</button>
                <button class="btn btn-light-error px-4" data-hs-overlay="#addContactModal">Discard</button> --}}
