            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data Matakuliah Universitas
                            Janabadra</h4>
                             ...
                             <table class="table search-table min-w-full divide-y divide-border dark:divide-darkborder">
                                    ...
                                    <tbody class="divide-y divide-border dark:divide-darkborder">
                                        ...
                                        <tr class="search-items">
                                            ...
                                            <td
                                                ...
                                                @if ($mt->semester == 1)
                                                    I
                                                @elseif ($mt->semester == 2)
                                                 II
                                                @elseif ($mt->semester == 3)
                                                 III
                                                @elseif ($mt->semester == 4)
                                                 IV
                                                @elseif ($mt->semester == 5)
                                                 V
                                                @elseif ($mt->semester == 6)
                                                 VI
                                                @elseif ($mt->semester == 7)
                                                 VII
                                                 @elseif ($mt->semester == 8)
                                                 VIII
                                            ...
                                            <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                                <div class="action-btn flex gap-3">
                                                    <a href="{{ route('matkul.edit', $mt->matakuliah_id) }}" class="text-info edit">
                                                    ...
                                                    <form action="{{ route('matkul.destroy', $mt->matakuliah_id) }}"
                                                        method="POST" id="delete-form-{{ $mt->matakuliah_id }}">
                                                        @csrf
                                                        @method('DELETE')

                                                        <button type="button" class="text-dark delete-btn" data-id="{{ $mt->matakuliah_id }}">
                                                            <i
                                                                class="ti ti-trash text-lg text-bodytext dark:text-darklink "></i>
                                                        </button>
                                                    </form>
                                ...
                                <div class="flex justify-center items-center gap-x-5 mt-4">
                                    <div class="pagination-wrapper">
                                        {{ $matkul->links('vendor.pagnation.custom') }}
                                    </div>
                                    <!-- Go To Page -->
           ...
           $(document).on('click', '.delete-btn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $('#delete-form-' + matakuliah_id).submit();
                }
            });
        });
        </script>
