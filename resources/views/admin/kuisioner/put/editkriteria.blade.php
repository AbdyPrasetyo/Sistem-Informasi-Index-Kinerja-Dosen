            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Form Perubahan Data Kriteria</h4>
                                        ...
                                        <div class="lg:col-span-12 ">
                                            <div class="contact-name">
                                                <h6 class="card-title mb-2">Kriteria Kuisioner</h6>
                                                    <textarea name="nama_kriteria" placeholder="Nama kriteria kuisioner"  id="c-name" cols="30" rows="5" class="form-control">{{ old('nama_kriteria', $kriteria->nama_kriteria) }}</textarea>
                                                    @error('nama_kriteria')
                                            <span
