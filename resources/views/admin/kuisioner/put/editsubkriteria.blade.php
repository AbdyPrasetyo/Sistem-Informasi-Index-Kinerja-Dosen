            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Form Perubahan Data SubKriteria</h4>
                        ...
                        <div class="col-span-12">
                                <form action="{{ route('subkriteria.update', $subkriteria->subkriteria_id) }}" method="POST">
                                    ...
                                    <div class="relative mb-3">
                                        ...
                                        <option value="{{ $kr->kriteria_id }}" {{ old('kriteria_id', $subkriteria->kriteria_id) == $kr->kriteria_id ? 'selected' : '' }}>{{ $kr->nama_kriteria }}</option>
                                        @endforeach
                                      ...
                                      @enderror
                                            ...
                                            <div class="contact-name">
                                                <h6 class="card-title mb-2">Sub Kriteria Kuisioner</h6>
                                                    <textarea name="nama_subkriteria" placeholder="Nama Subkriteria kuisioner"  id="c-name" cols="30" rows="5" class="form-control">{{ old('nama_subkriteria', $subkriteria->nama_subkriteria) }}</textarea>
