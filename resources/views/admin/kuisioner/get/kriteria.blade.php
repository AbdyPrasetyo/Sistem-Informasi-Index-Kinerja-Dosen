            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data Kriteria Universitas
                            Janabadra</h4>
                        ...
                        <div class="p-1.5 min-w-full inline-block align-middle">
                                    ...
                                    <tr class="search-items">
                                        ...
                                        <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            <div class="action-btn flex gap-3">
                                                <a href="{{ route('kriteria.edit', $kr->kriteria_id) }}" class="text-info edit">
                                                    <i class="ti ti-pencil text-lg"></i>
                                                </a>

                                                <form action="{{ route('kriteria.destroy', $kr->kriteria_id) }}"
                                                    method="POST" id="delete-form-{{ $kr->kriteria_id }}">
                                                    @csrf
                                                    @method('DELETE')

                                                    <button type="button" class="text-dark delete-btn" data-id="{{ $kr->kriteria_id }}">
                                                        <i
                            ...
                            <div class="flex justify-center items-center gap-x-5 mt-4">
                                <div class="pagination-wrapper">
                                    {{ $kriteria->links('vendor.pagnation.custom') }}
                                </div>
                                <!-- Go To Page -->
           ...
           $(document).on('click', '.delete-btn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $('#delete-form-' + kriteria_id).submit();
                }
            });
        });
        </script>
