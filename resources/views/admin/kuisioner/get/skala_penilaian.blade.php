            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data Skala Penilaian Kuisioner Universitas
                            Janabadra</h4>
                    ...
                    <div class="lg:col-span-4 md:col-span-12 sm:col-span-12 col-span-12 ">
                        <form class="relative max-w-64">
                            <input type="text" class="form-control product-search pl-11 py-2" id="input-search"
                                placeholder="Search Skala Penilaian..." />
                            <i
                        ...
                        <div class="p-1.5 min-w-full inline-block align-middle">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            ...
                                            Kategori Skala Penilaian</th>
                                        <th scope="col"
                                            class="text-left rtl:text-right  p-4 font-semibold text-dark dark:text-white text-sm">
                                            Nilai Skala Penilaian</th>
                                        <th scope="col"
                                            class="text-left rtl:text-right  p-4 font-semibold text-dark dark:text-white text-sm">
                                            Action</th>
                                    ...
                                    <tr class="search-items">
                                        ...
                                        <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                            <div class="action-btn flex gap-3">
                                                <a href="{{ route('skala.edit', $sk->skala_id) }}" class="text-info edit">
                                                ...
                                                <form action="{{ route('skala.destroy', $sk->skala_id) }}"
                                                    method="POST" id="delete-form-{{ $sk->skala_id }}">
                                                    @csrf
                                                    @method('DELETE')

                                                    <button type="button" class="text-dark delete-btn" data-id="{{ $sk->skala_id }}">
                                                        <i
                                                            class="ti ti-trash text-lg text-bodytext dark:text-darklink "></i>
                                                    </button>
                                                </form>
                            ...
                            <div class="flex justify-center items-center gap-x-5 mt-4">
                                <div class="pagination-wrapper">
                                    {{ $skala->links('vendor.pagnation.custom') }}
                                </div>
                                <!-- Go To Page -->
