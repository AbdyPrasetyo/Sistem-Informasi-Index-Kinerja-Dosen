            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data Dosen Universitas
                            Janabadra</h4>
                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="lg:col-span-8 md:col-span-12 sm:col-span-12 col-span-12">
                        <div class="flex justify-end items-center gap-3">
                            ...
                            <a href="{{ route('dosen/add/.create') }}" class="btn  flex gap-2 items-center ">
                            ...
                            <div class="overflow-hidden">
                                        ...
                                        <tr class="search-items">
                                            ...
                                            <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                                <div class="action-btn flex gap-3">
                                                    <a href="{{ route('dosen.edit',$ds->dosen_id) }}" class="text-info edit">
                                                    ...
                                                    <form action="{{ route('dosen.destroy', $ds->dosen_id) }}" method="POST" id="delete-form-{{ $ds->dosen_id }}">
                                                        @csrf
                                                        @method('DELETE')

                                                        <button type="button" class="text-dark delete-btn" data-id="{{ $ds->dosen_id }}">
                                                            <i
                                                                class="ti ti-trash text-lg text-bodytext dark:text-darklink"></i>
                                                        </button>
                                                    </form>
                                ...
                                <div class="flex justify-center items-center gap-x-5 mt-4">
                                    <div class="pagination-wrapper">
                                        {{ $dosen->links('vendor.pagnation.custom') }}
                                    </div>
                                    <!-- Go To Page -->
