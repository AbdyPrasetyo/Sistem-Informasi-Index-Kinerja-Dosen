            ...
            <div class="card-body md:py-3 py-5">
                <div class="flex items-center grid grid-cols-12 gap-6">
                    <div class="col-span-9">
                        <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Data Admin Universitas
                            Janabadra</h4>
                            ...
                            <div class="overflow-hidden">
                                        ...
                                        <tr class="search-items">
                                            ...
                                            <td class="text-sm whitespace-nowrap text-bodytext dark:text-darklink p-4">
                                                <div class="action-btn flex gap-3">
                                                    <a href="{{ route('admin.edit', $adm->admin_id) }}" class="text-info edit">
                                                    ...
                                                    <form  action="{{ route('admin.destroy', $adm->admin_id) }}"
                                                        method="POST" id="delete-form-{{ $adm->admin_id }}">
                                                        @csrf
                                                        @method('DELETE')

                                                        <button type="button" class="text-dark delete-btn" data-id="{{ $adm->admin_id }}">
                                                            <i
                                                                class="ti ti-trash text-lg text-bodytext dark:text-darklink "></i>
                                                        </button>
                                                    </form>
                                ...
                                <div class="flex justify-center items-center gap-x-5 mt-4">
                                    <div class="pagination-wrapper">
                                        {{ $admin->links('vendor.pagnation.custom') }}
                                    </div>
                                    <!-- Go To Page -->
                                    ...
                                    <!-- End Go To Page -->
                                    <!-- Items Per Page -->
                                    <form id="items-per-page-form" action="{{ url()->current() }}" method="GET" class="hs-dropdown relative inline-flex [--placement:top-]">
